    ...
    var asChoice = function() {
      function asChoice(select) {
        ...
        if (this.$options.length !== 0) {
          ...
          _jquery2.default.each(this.$options,

            function(i, v) {
              meta.status[(0, _jquery2.default)(v).attr('value')] = {};
              meta.status[(0, _jquery2.default)(v).attr('value')].text = (0, _jquery2.default)(v).text();
      ...
      _createClass(asChoice, [{
        key: 'init',
        value: function init() {
          var _this = this;

          var tpl = '<li><span class="' + this.namespace + '-text"></span></li>';
          ...
          _jquery2.default.each(this.status,
            ...
            function(key, value) {
              ...
              if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object') {
                ...
                if (value.icon) {
                  (0, _jquery2.default)('<i></i>').addClass(value.icon).appendTo($tpl);
                }
              ...
              _jquery2.default.each(_this.value,
        ...
        value: function _bindEvents() {
          var that = this;
          // unselected a link
          this.$wrap.find('a').on(this._eventName('click'),
          ...
          if (this.options.multiple === true) {
            this.$wrap.on(this._eventName('click touchstart'), 'li',

              function() {
                if ((0, _jquery2.default)(this).hasClass(that.classes.selected)) {
                  that.set((0, _jquery2.default)(this).data('value'), 'unselected');

                  return false;
                } else {
                  that.set((0, _jquery2.default)(this).data('value'), 'selected');

                  return false;
                }
              }
            );
            _jquery2.default.each(this.options.value,
        ...
        value: function set(value, status) {
          ...
          if (this.options.multiple === true) {
            ...
            _jquery2.default.each(this.$wrap.find('li'),
            ...
            var _ret = function() {
              ...
              var that = _this2;
              _jquery2.default.each(_this2.$options,
              ...
              _jquery2.default.each(_this2.$wrap.find('li'),
        ...
        value: function val(value, status) {
          ...
          if (value && status) {
            ...
            if (typeof value === 'string') {
              ...
              _jquery2.default.each(options,

                function(key, li) {
                  var data = (0, _jquery2.default)(li).data('value');

                  if (_jquery2.default.inArray(data, value)) {
                    _this3.set(data, 'selected');
                  } else {
                    _this3.set(data, 'unselected');
                  }
                }
              );
            }
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAMESPACE)) {
            (0, _jquery2.default)(this).data(NAMESPACE, new asChoice(this, options));
          }
        }
      );
    };
